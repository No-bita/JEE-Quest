...
const LegendCard: React.FC<LegendCardProps> = ({ questions }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow p-5 mt-6 border border-gray-100">
      <div className="flex flex-col gap-2">
        <div className="grid grid-cols-2 gap-y-2 gap-x-6">
          {/* Not Visited */}
          <div className="flex items-center gap-2">
            <span aria-label={`${notVisited} not visited`} className="inline-flex items-center justify-center w-8 h-8 rounded-full border border-gray-400 bg-gray-200 text-gray-700 font-normal text-sm shadow">{notVisited}</span>
            <span className="text-gray-700 text-sm font-normal">Not Visited</span>
          </div>
          {/* Not Answered */}
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-700 text-sm font-normal">Not Answered</span>
          </div>
          {/* Answered */}
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-700 text-sm font-normal">Answered</span>
          </div>
          {/* Marked for Review */}
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-700 text-sm font-normal">Marked for Review</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 mt-1 ml-1">
          ...
          <div className="flex flex-col leading-tight">
            <span className="text-gray-700 text-sm font-normal">Answered & Marked for Review</span>
